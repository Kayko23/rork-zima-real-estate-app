...
const ZIMA_LOGO_URL = 'https://pub-e001eb4506b145aa938b5d3badbff6a5.r2.dev/attachments/hsjrkh5pw0nem2p79g11e';
...
export default function ServicesScreen() {
  ...
  const renderStickySearch = () => (
    ...
    >
      {Platform.OS === 'web' ? (
        <View style={[styles.stickySearchBar, styles.webStickySearchBar]} />
      ) : (
        <BlurView intensity={20} tint="light" style={styles.stickySearchBar} />
      )}
      <View style={styles.stickySearchContent}>
        <View style={styles.searchInput}>
          <Search size={20} color={Colors.text.secondary} />
          <Text style={styles.searchPlaceholder}>
            {searchQuery || 'Rechercher par nom, ville ou spécialité'}
          </Text>
        </View>
      </View>
    </Animated.View>
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.logoBar}>
        {Platform.OS === 'web' ? (
          <View style={[styles.logoBarBackground, styles.webLogoBarBackground]} />
        ) : (
          <BlurView intensity={20} tint="light" style={styles.logoBarBackground} />
        )}
        <Image source={{ uri: ZIMA_LOGO_URL }} style={styles.logo} resizeMode="contain" />
      </View>

      {/* Sticky Search */}
      {isSearchSticky && renderStickySearch()}
      ...
      >
        ...
        <View style={styles.sectionSwitch}>
          <TouchableOpacity
            ...
            onPress={() => handleSectionSwitch('properties')}
          >
            <Text style={styles.sectionEmoji}>🏠</Text>
            <Text style={styles.sectionText}>Biens immobiliers</Text>
          </TouchableOpacity>
          <View style={[styles.sectionCard, styles.activeSectionCard]}>
            <Text style={styles.sectionEmoji}>💼</Text>
            <Text style={[styles.sectionText, styles.activeSectionText]}>Services</Text>
          </View>
        </View>
