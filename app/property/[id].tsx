...
const styles = StyleSheet.create({
  ...
  hero: { width, height: width * 0.6, resizeMode: "cover" },
  imgPager: { position: "absolute", right: 14, top: width * 0.6 - 28, backgroundColor: "rgba(0,0,0,0.4)", paddingHorizontal: 8, paddingVertical: 4, borderRadius: 12 },
