...
const ISO_BY_NAME: Record<string, string> = {
  ...
  'Cap-Vert':'CV','Gambie':'GM','Ghana':'GH','Guinée':'GN','Liberia':'LR','Nigeria':'NG','Sierra Leone':'SL',
  'Cameroun':'CM','Congo':'CG','Gabon':'GA','Tchad':'TD','République centrafricaine':'CF','Guinée équatoriale':'GQ'
};
