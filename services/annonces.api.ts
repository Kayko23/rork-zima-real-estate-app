...
const DEMO: Listing[] = [
  ...
  { id:"102", title:"Appartement cosy", city:"Dakar", country:"Sénégal", price:850, currency:"USD", type:"rent", surface:85, beds:2, baths:2, photos:["https://images.unsplash.com/photo-1501183638710-841dd1904471?w=1200"], rating:4.6, reviews:23, contacts:1, status:"pending", views:890 },
  { id:"103", title:"Studio centre-ville", city:"Abidjan", country:"Côte d'Ivoire", price:400, currency:"USD", type:"rent", surface:30, beds:1, baths:1, photos:["https://images.unsplash.com/photo-1494526585095-c41746248156?w=1200"], status:"expired", views:456 }
];